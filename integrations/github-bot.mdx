...
Integrate Gurubase with GitHub to ask your Guru directly within your GitHub repository issues. Check out [this example issue](https://github.com/Gurubase/gurubase/issues/248) to see it in action.
...
<Warning>
GitHub integration for self-hosted version is in testing phase and will be available once version 0.4.0 is released very soon. Watch [Gurubase GitHub repo](https://github.com/Gurubase/gurubase) for updates.
</Warning>
