...
<Frame>
  <img src="/images/bots/website-widget/gurubase-create-widget.png" alt="Create Widget ID" className="mt-4" />
</Frame>
...
<Frame>
  <img src="/images/bots/website-widget/gurubase-archbee-integration.jpg" alt="Archbee Custom Code Integration" className="mt-4" />
</Frame>
...
<Frame>
  <img src="/images/bots/website-widget/gurubase-gitbook-integration.jpg" alt="GitBook Integration Configuration" className="mt-4" />
</Frame>
