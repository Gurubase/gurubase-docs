...
16. Go to your guru's Slack integration page in the Gurubase UI and paste the bot token you copied and click "Connect".

<Frame>
  <img src="/images/slack-bot-token-input.png"/>
</Frame>

17. You can now follow the [Steps to Integrate](/integrations/slack-bot#steps-to-integrate).
