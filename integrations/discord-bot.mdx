...
7. Under "Default Install Settings", and under "Guild Install", add "bot" to the "Scopes". Then, "Permissions" will become visible. Add "Send Messages" to the permissions.
<img src="/images/discord-bot-permissions.png" width="500" className="mt-4"/>
9. Save changes.
...
<img src="/images/discord-bot-token-input.png" className="mt-4"/>
14. You can now follow the [Steps to Integrate](/integrations/discord-bot#steps-to-integrate).
