...
<Frame>
  <img src="/images/guides/actions/usage-instructions.png" alt="Usage Instructions Configuration" />
</Frame>
...
<Frame>
  <img src="/images/guides/actions/scheduling.png" alt="Schedule Configuration" />
</Frame>

**Scheduling Actions:**
- To schedule an action, all parameters must have default values
...
- Scheduled actions display their cron expression in the actions list
...
- View all configured actions with their name, type ("Python Code" or "API Call"), status (Enabled/Disabled), and schedule (cron expression if scheduled)
...
<Frame>
  <img src="/images/guides/actions/actions-history.png" alt="Action History" />
</Frame>

View the execution history for all actions from the Actions page by clicking the "History" button. The history table displays:

- **Status**: Execution outcome (Completed or Failed)
- **Action Name**: Name of the executed action
- **Type**: Action type (Python Code or API Call)
- **Source**: How the action was triggered (scheduled, through the test action button, question answer flow etc.)
...
<Frame>
  <img src="/images/guides/actions/actions-history-details.png" alt="Action Execution Details" />
</Frame>

**Execution Details Page:**
- **Execution Info**: Unique execution ID, status, depth, action name and type, source, and test flag
- **Timing**: Start time, duration, and completion time
- **Input Data**: Parameters and values used during execution (collapsible)
- **Output Data**: Response data or stdout from the execution (collapsible)
- **Action Config Snapshot**: Configuration state at the time of execution (collapsible)

This detailed view helps you debug failed executions, verify scheduled runs, and understand how actions performed with specific parameters.
