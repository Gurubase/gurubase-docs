...
Create your Guru on [app.gurubase.io](https://app.gurubase.io/) with a **7-day free trial**:

1. Sign up or log in at [app.gurubase.io](https://app.gurubase.io/)
2. Click **Create a Guru** to start the setup wizard
3. Configure your Guru's name, logo, and topics
4. Add your knowledge sources
5. Publish your Guru and start answering questions immediately
