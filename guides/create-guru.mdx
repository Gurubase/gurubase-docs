...
After creating a Guru, you can start using it through the Gurubase UI, [Website Widget](/integrations/website-widget), [Slack](/integrations/slack-bot), [Discord](/integrations/discord-bot), [GitHub](/integrations/github-bot) or [API](/api-reference/introduction).
...
4. [GitHub Bot](/integrations/github-bot): Add your Guru as a Github bot.
