...
For self-hosted deployments, follow these steps to create your Guru:

#### 1. Access the Dashboard

Navigate to your Gurubase dashboard at [http://localhost:8020](http://localhost:8020) and click the "Create New Guru" button to begin the setup process.
