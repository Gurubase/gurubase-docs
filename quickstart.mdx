...
- [Docker Compose](https://docs.docker.com/compose/install/) `2.6.1` or later
- OpenAI API key - Get it from [platform.openai.com/api-keys](https://platform.openai.com/api-keys)
- Firecrawl API key - Get it from [firecrawl.dev/app/api-keys](https://www.firecrawl.dev/app/api-keys)
...
2. Prompt for required API keys (OpenAI and Firecrawl)
