...
The root URL to be crawled. The crawler will start from this URL and follow all links that begin with it. For example, if the URL is https://example.com/a/b/c, the crawler will follow all links that start with https://example.com/a/b/c.
</ResponseField>
